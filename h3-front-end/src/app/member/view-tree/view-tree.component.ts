...
export class ViewTreeComponent implements OnInit, OnDestroy {
  ...
  private setUpTemplate(): void {
    ...
    OrgChart.templates.family_template_male = Object.assign({}, OrgChart.templates.family_template);
    OrgChart.templates.family_template_male.node = '<circle stroke-width="3" fill="none" stroke="#039BE5" cx="43" cy="43" r="41.5"></circle>';

    OrgChart.templates.family_template_female = Object.assign({}, OrgChart.templates.family_template);
    OrgChart.templates.family_template_female.node = '<circle stroke-width="3" fill="none" stroke="#ff4500" cx="43" cy="43" r="41.5"></circle>';
  }
  ...
  private createChart(): void {
    this.chart = new OrgChart(document.getElementById('tree'), {
      ...
      tags: {
        male: {
          template: 'family_template_male'
        },
        female: {
          template: 'family_template_female'
        }
      }
    });
